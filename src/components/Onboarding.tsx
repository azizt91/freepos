            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed max-w-xs mx-auto">
                {isInstalled || installDone
                  ? 'FreePOS sudah terinstall. Kamu bisa buka langsung dari home screen!'
                  : 'Install FreePOS di HP kamu supaya bisa diakses langsung dari home screen, tanpa buka browser.'}
              </p>
            </div>
            {!isInstalled && !installDone && (
              canInstall ? (
                <div className="space-y-3 w-full max-w-xs">
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      if (ok) {
                        setInstallDone(true);
                        toast.success('Berhasil install FreePOS!');
                      }
                    }}
                  >
